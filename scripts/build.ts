...
async function build() {
  ...
  // consola.info('Utils build')
  // execSync('pnpm run -C packages/utils build', { stdio: 'inherit' })

  // consola.info('Rek build')
  // execSync('pnpm run -C packages/rek build', { stdio: 'inherit' })
