...
async function handleTask(from: string, to: string, amount: number, payload: ContractEventPayload, next: NextFunction) {
...
async function handleTask_2(from: string, to: string, amount: number, payload: ContractEventPayload, next: NextFunction) {
