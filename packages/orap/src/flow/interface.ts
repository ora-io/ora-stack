...
export type HandleParams = [...any[], fn: NextFunction] | any[]
export type HandleFn = (...args: any[]) => Awaitable<boolean>
export type HandleFnWithNext = (...args: HandleParams) => Awaitable<boolean>
