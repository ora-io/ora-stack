...
import { BaseCrossCheckParam } from "../event/crosschecker/interface";

const ETHEREUM_RPC_URL: string = "https://rpc.ankr.com/eth";
const CONTRACT_ADDRESS: string = "0xdAC17F958D2ee523a2206206994597C13D831ec7";
export async function crossCheckerTest() {
  ...
  await cc.crossCheckRange({
    onMissingLog,
    ignoreLogs,
    fromBlock: 20003371, toBlock: 20003371, address: CONTRACT_ADDRESS, topics
  });
